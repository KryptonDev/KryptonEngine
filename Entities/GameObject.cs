...
{
	[Serializable, XmlInclude(typeof(Sprite)), XmlInclude(typeof(InteractiveObject)), XmlInclude(typeof(Character)), XmlInclude(typeof(Enemy)), XmlInclude(typeof(Wolf)), XmlInclude(typeof(Collectable))]
